...
def init_parser():
    ...
    parser.add_argument('-n', '--num_workers', type=int, required=True,
                        help='Number of GPU nodes to use (this should match'
                             'what is requested by sbatch in the calling'
                             'script)')
    return parser
...
if __name__ == '__main__':
    ...
    train_fashion_mnist(num_workers=inputs['num_workers'], use_gpu=True)
